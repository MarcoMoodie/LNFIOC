...
/* Generated from ../O.Common/LNFioc.dbd */
...
int LNFioc_registerRecordDeviceDriver(DBBASE *pbase)
{
    const char *bldTop = "/epics/ethercat-4-3/iocs/LNFIOC";
...
static const iocshFuncDef registerRecordDeviceDriverFuncDef =
                {"LNFioc_registerRecordDeviceDriver",1,registerRecordDeviceDriverArgs};
static void registerRecordDeviceDriverCallFunc(const iocshArgBuf *)
{
    LNFioc_registerRecordDeviceDriver(*iocshPpdbbase);
}
